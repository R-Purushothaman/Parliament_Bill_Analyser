...
genai.configure(api_key="AIzaSyCxqMoL61766yNMsp_XVrGfQzSaCztFgzc")
...
# ANALYSIS PROMPT
    ...
    if "analysis" in st.session_state:
        ...
        if question:
            chat_prompt = f"""
            Answer the user's question using ONLY the information from the given bill.
            If the answer is not mentioned in the bill, say:
